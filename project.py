...
# Label
mylabel = Label(root, text="Enter the video URL", font=("Arial", 12))
...
# Buttons
button1 = ttk.Button(root, text="High quality", command=lambda: start_download(['-f', 'best']))
button1.place(x=100, y=100)

button2 = ttk.Button(root, text="Low quality", command=lambda: start_download(['-f', 'worst']))
